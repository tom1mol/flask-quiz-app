...
app = Flask(__name__)                               #initialise new flask application
...
@app.route("/")                                     # create app route decorator and 
def index():                                        #define function that will be bound to our decorator
